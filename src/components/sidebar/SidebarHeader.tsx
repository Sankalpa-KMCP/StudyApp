    ...
    return (
      <header className="flex w-full flex-col items-center gap-2 pt-1 pb-0.5 select-none">
        ...
        <button
          ...
          className="sidebar-collapse-btn hidden md:flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-card surface-subtle text-muted hover:surface-track hover:text-secondary transition-all cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-blue"
        >
  ...
  return (
    <div className="flex items-center gap-3 px-1 py-0.5 select-none">
      ...
      <div className="min-w-0 flex-1 overflow-hidden">
        <h1 className="text-sm font-bold text-primary tracking-wide leading-none truncate" title="Study Dashboard">Study Dash</h1>
        <p className="text-caption text-muted font-medium mt-1.5 leading-none truncate" title="by Sankalpa KMCP">by Sankalpa KMCP</p>
      </div>
      <button
        type="button"
        onClick={onToggleCollapse}
